...
També, es normalitzen les paraules en les variables *Province* i *City* dels dos datasets, eliminant accénts i caràcters especials com la *ñ*. Per fer-ho es canvia el tipus de dades d'aquestes variables de UTF-8 a ASCII.
...
#g2<-ggplot(data=data, aes(x=Fuel_type, y=Price, color=Fuel_type)) +
#  geom_boxplot() +
